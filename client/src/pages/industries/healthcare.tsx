...
const data: IndustryPageData = {
  ...
  metaDescription:
    "We build websites for dentists, chiropractors, therapists, and med spas — designed to earn patient trust and fill your appointment book.",
  ...
  heroProps: {
    ...
    subheading:
      "Patients are trusting you with their health. Your website needs to reflect that level of care — professional, clear, and easy to navigate when someone is looking for help.",
    ...
    challenges: [
      {
        ...
        body: "Patients who can't book online at 9pm on a Tuesday will book with someone who lets them. Removing that friction is one of the highest-impact changes you can make.",
      },
      {
        icon: UserCheck,
        title: "Credentials Hard to Find",
        body: "Credentials, certifications, and provider bios are what patients look for to confirm they can trust you. If they're buried, trust doesn't form.",
      },
      {
        icon: BookOpen,
        title: "Jargon-Heavy Content",
        body: "Medical terminology that reads like a textbook creates anxiety instead of confidence. Patients need plain language that explains what to expect.",
      },
    ],
  },
  ...
  features: [
    {
      ...
      description:
        "Integrated scheduling that lets patients book directly from your site — connected to Calendly, Jane App, NexHealth, or whatever platform you already use.",
    },
    {
      icon: UserCheck,
      title: "Provider Bios & Credentials",
      description:
        "Detailed provider pages with photos, credentials, and personal background — giving hesitant new patients the confidence to choose your practice.",
    },
    {
      icon: BookOpen,
      title: "Clear Service & Treatment Pages",
      description:
        "Each service explained in plain, reassuring language focused on what the patient will experience — not clinical jargon that creates more questions than it answers.",
    },
    {
      icon: CreditCard,
      title: "Insurance Information Display",
      description:
        "Accepted plans listed clearly so patients can confirm coverage before their first visit — one of the most-searched items on any healthcare site.",
    },
    {
      icon: ShieldCheck,
      title: "HIPAA-Compliant Contact Forms",
      description:
        "Forms that collect only the minimum necessary information and are designed to avoid storing sensitive health data through the web layer.",
    },
    {
      icon: Star,
      title: "Testimonials & Review Integration",
      description:
        "Patient testimonials and Google reviews surfaced on your site — building social proof at the moment prospective patients are on the fence.",
    },
  ],
