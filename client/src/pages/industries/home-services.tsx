...
const data: IndustryPageData = {
  ...
  metaDescription:
    "We build websites for HVAC, plumbing, electrical, gutters, tree service, and landscaping businesses designed to drive calls and booked jobs.",
  ...
  heroProps: {
    ...
    subheading:
      "HVAC, plumbing, electrical, gutters, tree service, landscaping — we build sites specifically for home service businesses that need their phone ringing.",
    ...
    challenges: [
      {
        ...
        body: "On mobile, if your number isn't a tap-to-call link above the fold, customers leave. Most generic templates bury it in a footer.",
      },
      {
        icon: MapPin,
        title: "Single-City Visibility",
        body: "Serving 8 towns but only ranking in one is a revenue problem. Your site needs a dedicated strategy for every area you cover.",
      },
      {
        icon: Star,
        title: "Invisible Reviews",
        body: "You may have 80 five-star reviews on Google — but if they're not surfaced on your site, new visitors don't know they exist.",
      },
    ],
  },
  ...
  features: [
    {
      ...
      description:
        "Every page surfaces your phone number as a tap-to-call link where mobile users look first. Customers can reach you in two taps before the impulse to call passes.",
    },
    {
      icon: MapPin,
      title: "Service Area Landing Pages",
      description:
        "Dedicated pages for every city or zip code you cover. Each one targets the exact local search terms your potential customers type, multiplying your chances of showing up.",
    },
    {
      icon: Star,
      title: "Google Review Integration",
      description:
        "Your reviews are surfaced directly on your site, building social proof at the moment visitors are deciding whether to trust you — before they ever read them on Google.",
    },
    {
      icon: BarChart3,
      title: "Before / After Photo Galleries",
      description:
        "Showing the quality of your work builds confidence in a way descriptions can't. Organized galleries for each service type demonstrate expertise before the first call.",
    },
    {
      icon: FileText,
      title: "Estimate Request Forms",
      description:
        "Short, low-friction forms that let customers describe their problem and request a quote. Designed to have the highest possible completion rate.",
    },
    {
      icon: Search,
      title: "Local SEO Foundation",
      description:
        "Every page is built with the technical and content structure that helps Google understand your business, service area, and specialties — so you show up in map pack results.",
    },
  ],
