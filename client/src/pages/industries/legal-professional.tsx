...
const data: IndustryPageData = {
  ...
  metaDescription:
    "We build websites for law firms, CPAs, and consultants — designed to establish credibility, rank locally, and convert visitors into consultations.",
  ...
  heroProps: {
    ...
    subheading:
      "When clients are searching for a lawyer, CPA, or consultant, they're looking for someone they can trust. We build sites that establish that trust immediately.",
    ...
    challenges: [
      {
        ...
        body: "A site that just says 'we handle all legal matters' can't compete with a firm that clearly specializes in family law, DUI defense, or business litigation.",
      },
      {
        icon: FileText,
        title: "Missing Practice Pages",
        body: "'Divorce attorney [city]' and 'business litigation [city]' are separate searches. Without dedicated pages for each, you can't rank for either.",
      },
      {
        icon: User,
        title: "No Social Proof",
        body: "High-stakes clients look for reviews, case results, and client testimonials before they pick up the phone. A site without them loses to one that has them.",
      },
    ],
  },
  ...
  features: [
    {
      ...
      description:
        "A dedicated page for every practice area you handle — each optimized for the local search terms your ideal clients type when they need help.",
    },
    {
      icon: User,
      title: "Attorney & Professional Bios",
      description:
        "Compelling professional bios with credentials, experience, and background — giving prospective clients the context they need to feel confident picking up the phone.",
    },
    {
      icon: Award,
      title: "Results & Testimonials",
      description:
        "Case highlights and client reviews displayed prominently — the social proof that distinguishes your firm from every other generic listing in the same market.",
    },
    {
      icon: FileText,
      title: "Consultation Request Forms",
      description:
        "Low-friction intake forms with the right questions — designed to capture serious inquiries without overwhelming prospects who are still evaluating their options.",
    },
    {
      icon: DollarSign,
      title: "Fee Structure or 'How We Work'",
      description:
        "A clear explanation of your billing model or engagement process — reducing the #1 objection that stops motivated prospects from submitting an inquiry.",
    },
    {
      icon: Search,
      title: "Practice-Specific Local SEO",
      description:
        "Built to rank for the high-intent local searches — '[practice area] attorney in [city]' — that bring in the most motivated and best-qualified prospects.",
    },
  ],
