...
const data: IndustryPageData = {
  ...
  metaDescription:
    "We build websites for salons, barbershops, spas, and beauty businesses — with online booking, service galleries, and a design that matches your brand.",
  ...
  heroProps: {
    ...
    subheading:
      "New clients decide where to book based on what they see online. We build beauty and wellness sites that look as polished as your work — and make booking easy.",
    ...
    challenges: [
      {
        ...
        body: "Clients who want to book at 10pm can't reach you. A competitor with online booking gets that appointment instead — every single time.",
      },
      {
        icon: Image,
        title: "No Portfolio Gallery",
        body: "Beauty clients are visual buyers. Without a gallery of your actual work, they have no basis for choosing you over the salon down the street.",
      },
      {
        icon: Users,
        title: "Hidden Stylist Specialties",
        body: "If clients can't see who does what before they book, they'll book at a shop where they can see exactly who fits their needs.",
      },
    ],
  },
  ...
  features: [
    {
      ...
      description:
        "Direct integration with Vagaro, Booksy, StyleSeat, or your platform of choice — so clients can book at any hour without needing to pick up the phone.",
    },
    {
      icon: Sparkles,
      title: "Service Menu with Pricing",
      description:
        "A clean, easy-to-browse service menu with descriptions and pricing — so clients arrive informed and you spend less time answering the same questions.",
    },
    {
      icon: Users,
      title: "Stylist & Staff Profiles",
      description:
        "Individual profiles for each team member with their specialties, booking links, and portfolio photos — letting clients find their perfect match before they arrive.",
    },
    {
      icon: Image,
      title: "Work Portfolio Gallery",
      description:
        "A curated gallery showcasing your best cuts, color work, and treatments — the visual proof that converts browsers into booked clients.",
    },
    {
      icon: Gift,
      title: "Gift Cards & Special Offers",
      description:
        "Prominently featured gift card options and seasonal promotions — turning your website into a revenue source beyond just appointment bookings.",
    },
    {
      icon: Star,
      title: "Reviews & Social Proof",
      description:
        "Google reviews and client testimonials surfaced directly on your site — reassuring first-time visitors that your reputation is exactly as good as it is.",
    },
  ],
