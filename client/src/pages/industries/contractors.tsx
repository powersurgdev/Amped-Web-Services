...
const data: IndustryPageData = {
  ...
  metaDescription:
    "We build websites for remodelers, painters, flooring contractors, and general contractors — designed to generate estimate requests and close more jobs.",
  ...
  heroProps: {
    ...
    subheading:
      "Your work speaks for itself — but only if homeowners can find you and trust you before they reach out. We build contractor sites that generate estimate requests.",
    ...
    challenges: [
      {
        ...
        body: "Homeowners want to see what you've done before hiring you. Without a strong photo gallery, your quality is invisible no matter how good it actually is.",
      },
      {
        icon: Shield,
        title: "Hidden Credentials",
        body: "License numbers, insurance, and certifications build trust at exactly the moment homeowners are most skeptical. Burying them kills conversions.",
      },
      {
        icon: HardHat,
        title: "Missing Service Pages",
        body: "One generic 'services' page can't rank for bathroom remodeling, kitchen renovation, and deck building simultaneously. You need a page for each.",
      },
    ],
  },
  ...
  features: [
    {
      ...
      description:
        "Before/after galleries organized by service type give homeowners concrete proof of your craftsmanship — and keep them on your site long enough to decide.",
    },
    {
      icon: HardHat,
      title: "Per-Service Pages",
      description:
        "A dedicated page for each trade you offer — remodeling, painting, flooring, roofing — means you can rank in local search for every service separately.",
    },
    {
      icon: FileText,
      title: "Estimate Request Forms",
      description:
        "Simple, low-friction forms that ask the right questions. Designed to generate more submissions by removing every unnecessary field and friction point.",
    },
    {
      icon: Shield,
      title: "Credentials Front and Center",
      description:
        "License numbers, insurance status, and certifications displayed prominently near your CTAs — building trust at the exact moment it matters most.",
    },
    {
      icon: Search,
      title: "Local SEO Targeting",
      description:
        "Every service page is optimized for the searches homeowners in your area actually type, so you show up when they're actively looking to hire.",
    },
    {
      icon: Star,
      title: "Review Integration",
      description:
        "Your best Google reviews surface directly on your site, reinforcing your reputation without requiring visitors to leave the page to find them.",
    },
  ],
