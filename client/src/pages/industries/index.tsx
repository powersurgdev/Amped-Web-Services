...
const industries = [
  {
    icon: Wrench,
    title: "Home Services",
    description: "HVAC, plumbing, electrical, gutters, tree service, and landscaping companies.",
    href: "/industries/home-services",
  },
  {
    icon: HardHat,
    title: "Contractors & Trades",
    description: "Remodelers, painters, flooring companies, and general contractors.",
    href: "/industries/contractors",
  },
  {
    icon: UtensilsCrossed,
    title: "Restaurants & Food Service",
    description: "Restaurants, cafes, food trucks, and catering businesses.",
    href: "/industries/restaurants",
  },
  {
    icon: Heart,
    title: "Healthcare & Wellness",
    description: "Dentists, chiropractors, therapists, med spas, and wellness practitioners.",
  ...
  },
  {
    ...
    description: "Salons, barbershops, spas, and personal care businesses.",
    href: "/industries/beauty-wellness",
  },
  {
    icon: Car,
    title: "Auto & Transportation",
    description: "Auto mechanics, detailing shops, car washes, and towing companies.",
    href: "/industries/auto-services",
  },
  {
    icon: Camera,
    title: "Creative Professionals",
    description: "Photographers, videographers, artists, and creative freelancers.",
    href: "/industries/creative-portfolio",
  },
  {
    icon: Scale,
    title: "Legal & Professional Services",
    description: "Law firms, CPAs, consultants, and other professional services.",
    href: "/industries/legal-professional",
  },
  {
    icon: Dumbbell,
    title: "Fitness & Sports",
    description: "Gyms, personal trainers, yoga studios, and sports facilities.",
    href: "/industries/fitness-sports",
  },
];
...
export default function IndustriesHub() {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Industries We Serve — Amped Web Studios</title>
        <meta
          name="description"
          content="We build websites for local businesses across dozens of industries. Find your industry and see what we can do for you."
        />
      </Helmet>
      ...
      <main>
        ...
        <section className="py-16 sm:py-24 bg-gradient-to-br from-primary/10 via-primary/5 to-background">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            ...
            <Link href="/contact">
              <Button size="lg" className="text-base">Let's Talk</Button>
            </Link>
          </div>
        </section>
      </main>
