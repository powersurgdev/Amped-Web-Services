...
const data: IndustryPageData = {
  ...
  metaDescription:
    "We build personal brand websites for real estate agents and brokers — designed to generate buyer and seller leads and stand out from the competition.",
  ...
  heroProps: {
    ...
    subheading:
      "In real estate, your personal brand is everything. We build agent websites that make buyers and sellers choose you over every other agent in your market.",
    ...
    challenges: [
      {
        ...
        body: "Your brokerage page puts you alongside every other agent at the firm. Buyers and sellers want to know about you specifically — not the company.",
      },
      {
        icon: FileText,
        title: "No Lead Capture",
        body: "Without dedicated forms for home valuations, buyer consultations, and listing inquiries, your site generates traffic with nowhere to go.",
      },
      {
        icon: Target,
        title: "Weak Conversion Copy",
        body: "A generic bio and a phone number don't convert. Clients need to see your results, your personality, and proof that you know their market.",
      },
    ],
  },
  ...
  features: [
    {
      icon: UserCheck,
      title: "Agent Bio & Personal Brand Page",
      description:
        "A compelling professional bio that tells your story, highlights your track record, and gives buyers and sellers a clear reason to choose you over every other agent.",
    },
    {
      icon: FileText,
      title: "Buyer & Seller Lead Forms",
      description:
        "Dedicated forms for home valuations, buyer consultations, and listing inquiries — tied to high-value content that makes filling them out feel worthwhile.",
    },
    {
      icon: Home,
      title: "Featured Listings Section",
      description:
        "Showcase your active and recent listings with photos and key details — giving visitors a concrete view of your market activity and expertise.",
    },
    {
      icon: Map,
      title: "Neighborhood Guides",
      description:
        "Local area content that demonstrates you know the market — and that also ranks in Google for buyers searching neighborhoods they're considering.",
    },
    {
      icon: Star,
      title: "Testimonials & Past Sales",
      description:
        "Client reviews and past sale highlights surfaced prominently — the social proof that moves hesitant prospects from curious to ready to call.",
    },
    {
      icon: Target,
      title: "Clear Buyer & Seller CTAs",
      description:
        "Separate conversion paths for buyers and sellers so every visitor lands on content and a call-to-action that speaks directly to their situation.",
    },
  ],
